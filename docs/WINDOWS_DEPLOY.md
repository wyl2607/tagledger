...
This guide covers the current Windows delivery path for Machine Label OCR.
...
- `MAC_DEMO.md` and the macOS README section use `/Users/yumei/...`, Homebrew, `.venv/bin/pip`, and `brew install zbar tesseract`.
